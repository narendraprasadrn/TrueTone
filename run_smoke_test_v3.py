...
# Just filter for target IDs
ds_subset = ds.filter(lambda x: x['id'] in target_ids)
ds_subset = ds_subset.cast_column("audio", Audio(sampling_rate=16000))

print(f"Found {len(ds_subset)} samples for testing.")
